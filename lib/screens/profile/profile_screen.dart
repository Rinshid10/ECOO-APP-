...
/// Profile screen with modern UI design
/// Features animated header, quick actions, and organized menu sections
...
class _ProfileScreenState extends State<ProfileScreen>
      ...
      body: Consumer<UserProvider>(
        builder: (context, userProvider, child) {
          return CustomScrollView(
            slivers: [
              // Animated profile header with quick actions overlay
              SliverToBoxAdapter(
  ...
  /// Build header with quick actions overlapping at the bottom
  Widget _buildHeaderWithQuickActions(
    ...
    return Stack(
      ...
      children: [
        ...
        // Quick actions positioned at the bottom, overlapping the header
        Positioned(
          left: 20,
          right: 20,
          bottom: -40,
  ...
  /// Build animated profile header with gradient background
  Widget _buildAnimatedHeader(BuildContext context, UserProvider userProvider) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          // Add bottom margin to account for quick actions overflow
  ...
  /// Build quick action buttons card (positioned by parent Stack)
  ...
  /// Build individual stat card with animation
